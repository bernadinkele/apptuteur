...
class __TwigTemplate_219f4c1068940daa6e0c4b9b712368bd extends Template
{
    ...
    <div class=\"row justify-content-center\">
        ...
        if ((($tmp = (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 19, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "                        <div class=\"alert alert-danger\" role=\"alert\">
                            ";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 21, $this->source); })()), "html", null, true);
            yield "
                        </div>
                    ";
        }
...
";
    ...
    {
        return array (  124 => 24,  118 => 21,  115 => 20,  113 => 19,  110 => 18,  101 => 15,  98 => 14,  94 => 13,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
{% endblock %}
", "auth/login.html.twig", "/var/www/apptuteur/templates/auth/login.html.twig");
    }
}
